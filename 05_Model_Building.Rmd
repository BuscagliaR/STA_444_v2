...
In this chapter we will focus on the introduction of the `broom` package, part of the `tidyverse` suite of packages.
...
standardize modeling object interfaces, but there will always be a little weirdness.
...
```{r}
model <- t.test(SAT ~ Gender, data=GPAbySex)
