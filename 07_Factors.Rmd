...
In this chapter we will learn to handle factors, a key data structure in programming langauges to handled strings within models and analysis in a light-weight and flexible manner.  The chapter primarily leverages the functionality within the `forcats` package of the `tidyverse` suite.
