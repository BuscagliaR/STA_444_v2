...
#                          'Northern Mariana Islands[13]', 'The 50 states', 'The 50 states and D.C.',
#                          'Total US and territories', 'Contiguous United States') ) )  %>%
...
State_Pop %>%
  ...
  ggplot( aes(x=State, y=Percent_Change) ) +
    geom_col( ) +
    labs(x=NULL, y='% Change', title='State Population growth 2020-2023') +
    coord_flip() +
